...
function App() {
  ...
  return (
    ...
    <div className="min-h-full flex items-center justify-center p-6">
      {/* Heading Container:*/}
      <div className="max-w-xl w-full text-center bg[--border-white/10 p-8 rounded-2xl backdrop-blur-sm">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          {/* Button Corner Roundness Control */}
...
function Select({ value, onChange, options }) {
  return (
    <select
      ...
      className="w-full bg-white/80 text-slate-900 px-3 py-2 rounded-md outline-none ring-1 ring-slate-300 focus:ring-2 forcus:ring-indigo-400"
    >
      {options.map((opt) => (
